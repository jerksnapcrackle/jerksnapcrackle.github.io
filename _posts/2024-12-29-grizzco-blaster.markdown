...
On the other hand, although we can control the brightness of LED linearly, human eye's perception of brightness is not linear. So we should also do the gamma correction. 
...
(BTW, the handler was from sploosh-o-matic)

![trigger](/assets/grizzco-blaster/trigger.png)

Also, to make the charging and blinking look smooth, specialized brightness curves are needed to be designed.
...
> TODO : add charging/discharging sound effects
